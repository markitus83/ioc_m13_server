...
public class UsuariControllerHaDe {
    ...
    public void retornarErrorSiNoSInformaElNomAlRegistrarUnNouUsuariAmbRolProveidor()
        ...
        Usuari nouUsuari = donatUnNouUsuari(idUsuari, email, unaContrasenya, Rol.ADMINISTRADOR, null, cif, direccio, poblacio, provincia);
    ...
    public void retornarErrorSiNoSInformaElCifAlRegistrarUnNouUsuariAmbRolProveidor()
        ...
        Usuari nouUsuari = donatUnNouUsuari(idUsuari, email, unaContrasenya, Rol.ADMINISTRADOR, nom, null, direccio, poblacio, provincia);
    ...
    public void retornarErrorSiNoSInformaLaDireccioAlRegistrarUnNouUsuariAmbRolProveidor()
        ...
        Usuari nouUsuari = donatUnNouUsuari(idUsuari, email, unaContrasenya, Rol.ADMINISTRADOR, nom, cif, null, poblacio, provincia);
    ...
    public void retornarErrorSiNoSInformaLaPoblacioAlRegistrarUnNouUsuariAmbRolProveidor()
        ...
        Usuari nouUsuari = donatUnNouUsuari(idUsuari, email, unaContrasenya, Rol.ADMINISTRADOR, nom, cif, direccio, null, provincia);
    ...
    public void retornarErrorSiNoSInformaLaProvinciaAlRegistrarUnNouUsuariAmbRolProveidor()
        ...
        Usuari nouUsuari = donatUnNouUsuari(idUsuari, email, unaContrasenya, Rol.ADMINISTRADOR, nom, cif, direccio, poblacio, null);
